...
def integrate(lr0_1: LR, lr0_2: LR, lr0_3: LR, lr0_4: LR, grid_1, grid_2, grid_3, grid_4, t_f: float, dt: float, option: str = "lie", tol_sing_val: float = 1e-6, drop_tol: float = 1e-6):
    lr_1 = lr0_1
    lr_2 = lr0_2
    lr_3 = lr0_3
    lr_4 = lr0_4
    ...
    with tqdm(total=t_f/dt, desc="Running Simulation") as pbar:
        ...
        while t < t_f:
            ...
            ### Compute F_b
            F_b_1 = computeF_b(t, lr_1.U @ lr_1.S @ lr_1.V.T, grid_1, f_right = lr_2.U @ lr_2.S @ lr_2.V.T)
            F_b_2 = computeF_b(t, lr_2.U @ lr_2.S @ lr_2.V.T, grid_2, f_left = lr_1.U @ lr_1.S @ lr_1.V.T, f_right = lr_3.U @ lr_3.S @ lr_3.V.T)
            F_b_3 = computeF_b(t, lr_3.U @ lr_3.S @ lr_3.V.T, grid_3, f_left = lr_2.U @ lr_2.S @ lr_2.V.T, f_right = lr_4.U @ lr_4.S @ lr_4.V.T)
            F_b_4 = computeF_b(t, lr_4.U @ lr_4.S @ lr_4.V.T, grid_4, f_left = lr_3.U @ lr_3.S @ lr_3.V.T)
...
plt.tight_layout()
plt.savefig(savepath + "dd_4domains_distr_funct_initalltanh_fixedcol_t" + str(t_f) + "_" + method + "_" + str(dt) + "_adaptrank_" + str(Nx) + "x" + str(Nmu) + ".pdf")
