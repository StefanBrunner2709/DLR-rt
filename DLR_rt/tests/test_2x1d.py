...
#       change this as well, usch that we only look at adveciton, not collision
...
class ModelTestCase(unittest.TestCase):
    ...
    def test_frobenius_norm(self):
        '''
        Test if error in frobenius norm from inital value and end value at t=1 is not huge
        '''
